...
class ChatViewModel(
    ...
    suspend fun getOrCreateChat(itemId: String, requesterId: String, ownerId: String, itemImageUrl: String = "", itemTitle: String = ""): Chat? =
        repo.getOrCreateChat(itemId, requesterId, ownerId, itemImageUrl, itemTitle).getOrNull()
